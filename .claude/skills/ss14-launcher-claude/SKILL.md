---
name: ss14-launcher-claude
description: Expert coding guidance for the Space Station 14 launcher repository. Use when Claude edits, reviews, debugs, tests, refactors, or plans code in SS14.Launcher, SS14.Loader, SS14.Launcher.Bootstrap, Robust.LoaderApi, build scripts, Avalonia XAML, localization, SQLite migrations, updater, authentication, server browser, content download, process launch, packaging, or release workflows.
---

# SS14 Launcher Claude
...
- Read the relevant files before editing. Use file search, symbol search, nearby tests, and call sites to understand the local pattern.
- Use a todo list for multi-step work when available, but keep the implementation focused.
...
- Prefer concrete code changes plus validation over long design discussion unless the user asks for planning.
